...
class GetSpecialHoroscope(BaseHoroscope, GetJulianDate):
    ...
    def user_request(self) -> str:
        ...
        res = ('Составь гороскоп с особенностями характерными знаку'
               ...
               f'Положительное влияние будет оказывать знак зодиака '
               f'{self.moon_in_sign()[0]}, астрологический дом: '
               f'{self.moon_in_sign()[1]}. Негативное влияние будет оказывать '
               f'{self.opposite_zodiac_sign()[0]}, астрологический '
               f'дом: {self.opposite_zodiac_sign()[1]}'
               f'Лунный день сейчас {self.get_lunar_day()}. '
